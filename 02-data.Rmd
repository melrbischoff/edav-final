...
# greenhouse_emissions_data = read.csv("datasets/ev_data_sets/nys/Inventory_of_New_York_City_Greenhouse_Gas_Emissions_-_Electricity_Emission_Factors__2005-2016_.csv")
...
# ev_registrations_data = read.csv("datasets/ev_data_sets/nys/ny_ev_registrations.csv")

# https://data.ny.gov/Energy-Environment/Electric-Vehicle-Charging-Stations-in-New-York/7rrd-248n
ev_charging_data = read.csv("datasets/ev_data_sets/nys/Electric_Vehicle_Charging_Stations_in_New_York.csv")
...
# evaluate_ny_sheets <- read_excel_sheets("datasets/ev_data_sets/nys/evaluate_ny_EValuateNY.xlsx")
...
We also made use of a [non-Open-NYC dataset](https://data.beta.nyc/en/dataset/pediacities-nyc-neighborhoods/resource/7caac650-d082-4aea-9f9b-3681d568e8a5) to access its variables mapping zip codes to boroughs. It has 177 entries. 
